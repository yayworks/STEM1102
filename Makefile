...
image: Dockerfile
	docker build -t oflab1101 .

tag: image
	docker tag oflab1101 yayworks/oflab1101:latest && docker tag oflab1101 yayworks/oflab1101:5

all : tag
	docker push yayworks/oflab1101:latest && docker push yayworks/oflab1101:5
